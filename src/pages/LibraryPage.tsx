...
import { UpcomingView } from './UpcomingPage';

interface LibraryPageProps {
  defaultTab?: 'watchlist' | 'upcoming' | 'history';
}
...
export const LibraryPage: React.FC<LibraryPageProps> = ({ defaultTab }) => {
  ...
  const [activeMainTab, setActiveMainTab] = useState<'watchlist' | 'upcoming' | 'history'>(() => {
    ...
    <div className="min-h-screen pb-24 text-foreground selection:bg-orange-500 selection:text-white" id="library-page-root">
      ...
      <section className="border-b border-border bg-card py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-muted font-medium">
                  {totalWatchlist} in Watchlist • Upcoming Premieres • {totalHistory} in History
                </span>
              </div>
              ...
              <p className="text-sm text-muted max-w-2xl">
                Organize your bookmarked cinema, track upcoming premiere releases, and revisit all watched films and television series in one unified vault.
              </p>
            </div>
          ...
          {/* Main Tab Toggle: Watchlist vs Upcoming vs History */}
      ...
      {/* ---------------- TAB 1 & 2: FILTERS ROW (For Watchlist & History) ---------------- */}
      {activeMainTab !== 'upcoming' && (
                ...
                <div className="py-20 text-center space-y-4 rounded-3xl bg-card border border-border p-8">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted max-w-md mx-auto">
                      Explore trending movies and series, click "+ Watchlist", and your saved releases will appear right here.
                    </p>
                  </div>
                  <Link
                    to="/movies"
                      ...
                      <div className="relative aspect-[2/3] w-full overflow-hidden bg-surface">
                        ...
                        <div className="absolute top-2 left-2 flex flex-col gap-1">
                          <span className="px-2 py-0.5 rounded-md bg-black/70 backdrop-blur-md text-[10px] font-bold text-white uppercase tracking-wider">
                            {item.media.type === 'tv' ? 'series' : item.media.type}
                          </span>
                        </div>
